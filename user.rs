...
pub mod user_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/user.UserService/Hello" => {
                    #[allow(non_camel_case_types)]
                    struct HelloSvc<T: UserService>(pub Arc<T>);
                    impl<T: UserService> tonic::server::UnaryService<super::HelloRequest>
                    for HelloSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as UserService>::hello(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
